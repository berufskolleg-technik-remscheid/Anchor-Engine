...
public class AnchorEngine {
    ...
    public AnchorEngine(SimpleRenderLayer simpleRenderLayer, SimpleAudioLayer simpleAudioLayer) {
        this.simpleRenderLayer = simpleRenderLayer;
        this.simpleAudioLayer = simpleAudioLayer;
    }
